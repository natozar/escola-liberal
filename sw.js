// Escola Liberal PWA — Service Worker v216
...
const CACHE_NAME = 'escola-liberal-v241';
const STATIC_CACHE = 'escola-static-v241';
...
const CORE_ASSETS = [
  ...
  './stripe-billing.js',
  './lessons/index.json',
  './lessons/integrity.json',
  './cert.html',
  './institucional.html',
  './trader.html',
  './assets/icons/og-trader.jpg',
  './jogo.html',
  './assets/jogo/crise.jpg',
  './assets/jogo/solucao.jpg',
  './assets/jogo/vitoria.jpg',
  './assets/jogo/derrota.jpg',
  './assets/jogo/promessa.jpg',
  './assets/jogo/mercado-paralelo.jpg',
  './assets/jogo/moradia-crise.jpg',
  './assets/jogo/cratera.jpg',
  './assets/jogo/escola-teto.jpg',
  './assets/jogo/vales.jpg',
  './assets/jogo/banca-jornal.jpg',
  './assets/jogo/padaria-povo.jpg',
  './assets/jogo/estadio-obra.jpg',
  './assets/jogo/comercio-fechado.jpg',
...
const LAZY_ASSETS = ['./lessons.json', './lessons/index.json'].concat(
  Array.from({length:174},(_,i)=>'./lessons/mod-'+i+'.json')
);
